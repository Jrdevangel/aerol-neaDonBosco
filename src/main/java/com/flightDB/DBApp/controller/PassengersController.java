// src/main/java/com/flightDB/DBApp/controller/PassengersController.java
...
public class PassengersController {
    ...
    public ResponseEntity<Passengers> getPassengerById(@PathVariable Long id) {
        ...
        return passengerOpt.map(ResponseEntity::ok).orElseGet(() -> ResponseEntity.notFound().build());
    }
